...
/// Base class used when passing texture data to Vuforia::Renderer
/**
...
public:
    ...
    /// Returns the value of the type of the class (see Vuforia::INIT_FLAGS)
    int type() const { return mType; }

protected:
    /// The constructor of the sub-class sets the type, which is one of
    /// the values defined in Vuforia::INIT_FLAGS
...
/// Base class used when passing texture unit information to Vuforia::Renderer
/**
...
/// Base class used when passing 3D graphics rendering API-specific data to 
/// Vuforia::Renderer
/**
