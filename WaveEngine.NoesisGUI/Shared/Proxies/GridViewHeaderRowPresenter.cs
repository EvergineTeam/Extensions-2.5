...
public class GridViewHeaderRowPresenter : GridViewRowPresenterBase {
  internal new static GridViewHeaderRowPresenter CreateProxy(IntPtr cPtr, bool cMemoryOwn) {
    return new GridViewHeaderRowPresenter(cPtr, cMemoryOwn);
  }

  internal GridViewHeaderRowPresenter(IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn) {
  }
  ...
  public string ColumnHeaderStringFormat {
    ...
    get {
      IntPtr strPtr = NoesisGUI_PINVOKE.GridViewHeaderRowPresenter_ColumnHeaderStringFormat_get(swigCPtr);
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
