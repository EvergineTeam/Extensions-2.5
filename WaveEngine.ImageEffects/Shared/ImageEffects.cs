...
namespace WaveEngine.ImageEffects
{
    ...
    public static class ImageEffects
    {
        ...
        /// <summary>
        /// Gets a new <see cref="DepthOfFieldLens"/>.
        /// </summary>
        /// <returns>A instance of DepthOfFieldLens</returns>
        public static DepthOfFieldLens DepthOfField()
        {
            DepthOfFieldLens dof = new DepthOfFieldLens();
        ...
        /// <summary>
        /// Gets a new <see cref="FogLens"/>.
        /// </summary>
        /// <returns>A instance of FogLens</returns>
        public static FogLens Fog()
        {
            return new FogLens();
        }

        /// <summary>
        /// Gets a new <see cref="GaussianBlurLens"/>.
        /// </summary>
        /// <returns>A instance of GaussianBlurLens</returns>
        public static GaussianBlurLens GaussianBlur()
        {
            return new GaussianBlurLens();
        }
        ...
        /// <summary>
        /// Gets a new <see cref="LensFlare"/>.
        /// </summary>
        /// <returns>A instance of LensFlare.</returns>
        public static LensFlareLens LensFlare()
        {
            return new LensFlareLens();
        }

        /// <summary>
        /// Gets a new <see cref="LightShaftLens"/>.
        /// </summary>
        /// <returns>A instance of LightShaftLens.</returns>
        public static LightShaftLens LightShaft()
        {
            return new LightShaftLens();
        }

        /// <summary>
        /// Gets a new <see cref="MotionBlurLens"/>.
        /// </summary>
        /// <returns>A instance of MotionBlurLens.</returns>
        public static MotionBlurLens MotionBlur()
        {
            return new MotionBlurLens();
        }
        ...
        /// <summary>
        /// Gets a new <see cref="SSAOLens"/>.
        /// </summary>
        /// <returns>A instance of SSAOLens.</returns>
        public static SSAOLens SSAO()
        {
            return new SSAOLens();
        }
