...
namespace WaveEngine.ImageEffects
{
    ...
    /// </summary>
    public class GrayScaleMaterial : Material
    {
        /// <summary>
        /// The texture
        /// </summary>
        ...
        {
            new ShaderTechnique("GrayScale", "ImageEffectMaterial", "ImageEffectvsImageEffect", string.Empty, "GrayScalepsGrayScale", VertexPositionTexture.VertexFormat),
        };
        ...
        #region Initialize
        /// <summary>
        /// Initializes a new instance of the <see cref="GrayScaleMaterial"/> class.
        /// </summary>
