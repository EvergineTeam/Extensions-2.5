...
{
    /// <summary>
    /// Provides an abstraction to track changes on a <see cref="byte"/> property contained on a
    ...
    public abstract class NetworkBytePropertySync<K> : NetworkPropertySync<K, byte>
