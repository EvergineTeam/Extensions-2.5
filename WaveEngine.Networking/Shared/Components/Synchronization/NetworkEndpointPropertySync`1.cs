...
{
    /// <summary>
    /// Provides an abstraction to track changes on a <see cref="NetworkEndpoint"/> property contained on a
    ...
    public abstract class NetworkEndpointPropertySync<K> : NetworkPropertySync<K, NetworkEndpoint>
        where K : struct, IConvertible
    {
        ...
        /// <inheritdoc />
        protected override void WriteValue(NetworkPropertiesTable propertiesTable, NetworkEndpoint value)
        {
