...
{
    /// <summary>
    /// Provides an abstraction to track changes on a <see cref="string"/> property contained on a
    ...
    public abstract class NetworkStringPropertySync<K> : NetworkPropertySync<K, string>
