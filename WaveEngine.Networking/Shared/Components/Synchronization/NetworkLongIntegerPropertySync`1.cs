...
{
    /// <summary>
    /// Provides an abstraction to track changes on a <see cref="long"/> property contained on a
    ...
    public abstract class NetworkLongIntegerPropertySync<K> : NetworkPropertySync<K, long>
