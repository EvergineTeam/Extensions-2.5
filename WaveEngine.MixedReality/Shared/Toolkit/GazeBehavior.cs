...
namespace WaveEngine.MixedReality.Toolkit
{
    ...
    public class GazeBehavior : Behavior
    {
        ...
        /// </summary>
        [DataMember]
        [RenderPropertyAsFInput(0.2f, 100000, Tooltip = "Maximum gaze distance, in meters, for calculating a hit.")]
        public float MaxGazeDistance { get; set; }
        ...
        {
            base.DefaultValues();
            this.DefaultDistance = 2.0f;
            this.MaxGazeDistance = 100.0f;
