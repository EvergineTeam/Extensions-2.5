...
namespace WaveEngine.MixedReality.Interaction
{
    ...
    /// </summary>
    [DataContract(Namespace = "WaveEngine.MixedReality.Interaction")]
    public class SpatialInputService : Service, IDisposable
    {
        /// <summary>
        /// The left hand index
        /// </summary>
        public static readonly int LeftHandIndex = 0;

        /// <summary>
        /// The right hand index
        /// </summary>
        public static readonly int RightHandIndex = 1;
        ...
        /// </summary>
        [DataMember]
        private SpatialGestures enabledGestures;
        ...
        public VRGenericControllerState[] GenericControllerStates
        {
            get
            {
                return this.IsConnected ? this.spatialInputManager.GenericControllersArray : this.emptyControllersArray;
            }
        }
        ...
        public int LeftControllerIndex
        {
            get
            {
                return this.IsConnected ? LeftHandIndex : -1;
            }
        }
        ...
        public int RightControllerIndex
        {
            get
            {
                return this.IsConnected ? RightHandIndex : -1;
            }
        }
        ...
        protected override void Initialize()
        {
            if (this.IsConnected)
            {
                ...
                this.spatialInputManager.EnabledGestures = this.enabledGestures;
            }
        }
