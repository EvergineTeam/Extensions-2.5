...
{
    public class StaggeredNeighbours : NeighboursCollection
    {
        /// <summary>
        /// The stagger axis
        /// </summary>
        ...
        public override LayerTile TopRight
        {
            get
            {
                ...
                {
                    return this.tileMapLayer.GetLayerTileByMapCoordinates(this.center.X + 2, this.center.Y);
                }
            }
        }
        ...
        public override LayerTile BottomRight
        {
            get
            {
                if (this.staggerAxis == TiledMapStaggerAxisType.Y)
                {
                    return this.tileMapLayer.GetLayerTileByMapCoordinates(this.center.X, this.center.Y + 2);
                }
                else
                {
                    return this.tileMapLayer.GetLayerTileByMapCoordinates(this.center.X, this.center.Y + 1);
